...
input is hard coded probabilites will be generated by module 1 generated by bayesian network(module 2) with that it will search the best staredy.
Also the best Algorithm that we should use.
